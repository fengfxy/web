...
******************************************************************************/
		...
		if (messStr != "找回") {
			...
			sendMailData.setAddress(temp.getEmail());
			sendMailData.setTitle("密码找回");
			sendMailData.setInfo("<p><h1>FXY新闻信息系统——用户密码找回验证</h1></p>" 
					+ "<p>点击下面“立即验证”按钮验证您的账号</p>"
